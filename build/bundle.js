...
(function () {
    ...
    const file = "src/HelloJekyll.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t6 = text(" component.");
    			attr_dev(h1, "class", "svelte-11ckkv4");
    			add_location(h1, file, 19, 1, 277);
    			add_location(em, file, 20, 14, 314);
    			add_location(p, file, 20, 1, 301);
    			attr_dev(section, "class", "svelte-11ckkv4");
    			add_location(section, file, 18, 0, 266);
    		},
    ...
    const file$1 = "src/Sample.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			em.textContent = "svelte";
    			t4 = text(" component.");
    			attr_dev(h1, "class", "svelte-azjoz0");
    			add_location(h1, file$2, 15, 2, 254);
    			add_location(em, file$2, 16, 15, 287);
    			add_location(p, file$2, 16, 2, 274);
    			attr_dev(section, "class", "svelte-azjoz0");
    			add_location(section, file$2, 14, 0, 242);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
